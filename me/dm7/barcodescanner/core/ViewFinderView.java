...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private int mViewFinderOffset = null;
    ...
    public synchronized void updateFramingRect() {
        ...
        if (this.mSquareViewFinder) {
            ...
            screenOrientation = (int) (((float) getHeight()) * 0.625f);
            i = screenOrientation;
            screenOrientation = (int) (LANDSCAPE_WIDTH_HEIGHT_RATIO * ((float) screenOrientation));
        } else {
            screenOrientation = (int) (((float) getWidth()) * 0.75f);
            i = (int) (0.75f * ((float) screenOrientation));
        }
        ...
        int i3 = (point.y - i) / 2;
        this.mFramingRect = new Rect(this.mViewFinderOffset + i2, this.mViewFinderOffset + i3, (i2 + screenOrientation) - this.mViewFinderOffset, (i3 + i) - this.mViewFinderOffset);
    }
}
