...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderWidth = context.getDimensionPixelSize(R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = context.getColor(R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = context.getBoolean(R.styleable.CircleImageView_civ_border_overlay, false);
        this.mFillColor = context.getColor(R.styleable.CircleImageView_civ_fill_color, 0);
        context.recycle();
        init();
    }
