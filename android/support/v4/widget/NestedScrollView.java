...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
    ...
    boolean overScrollByCompat(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        int i12 = computeHorizontalScrollRange() > computeHorizontalScrollExtent() ? 1 : false;
        int i13 = computeVerticalScrollRange() > computeVerticalScrollExtent() ? 1 : false;
        if (overScrollMode != 0) {
            if (overScrollMode != 1 || i12 == 0) {
                z2 = false;
                if (overScrollMode != 0) {
                    if (overScrollMode == 1 || i13 == 0) {
                        z3 = false;
                        overScrollMode = i3 + i;
                        i9 = z2 ? 0 : i7;
                        i12 = i4 + i2;
                        ...
                        if (i12 <= i13) {
                            ...
                            if (z2 && !hasNestedScrollingParent(1)) {
                                nestedScrollView.mScroller.springBack(i10, i11, 0, 0, 0, getScrollRange());
                            }
                            onOverScrolled(i10, i11, z4, z2);
                            if (z4 || z2) {
                                return true;
                            }
                            return false;
