...
public class LinearSystem {
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (true) {
            float f2 = 0.0f;
            if (i >= linearSystem.mNumRows) {
                break;
            }
            if (linearSystem.mRows[i].variable.mType != Type.UNRESTRICTED) {
                if (linearSystem.mRows[i].constantValue < 0.0f) {
                    break;
                }
            }
            i++;
            ...
            while (obj == null) {
                ...
                int i5 = 0;
                int i6 = 0;
                while (i5 < linearSystem.mNumRows) {
                    int i7;
                    ...
                    int i9;
                    float f5;
                    ArrayRow arrayRow = linearSystem.mRows[i5];
                    if (arrayRow.variable.mType == Type.UNRESTRICTED) {
                        if (arrayRow.isSimpleDefinition) {
                            if (arrayRow.constantValue < f2) {
                                i7 = 1;
                                while (i7 < linearSystem.mNumColumns) {
                                    solverVariable = linearSystem.mCache.mIndexedVariables[i7];
                                    f = arrayRow.variables.get(solverVariable);
                                    if (f <= f2) {
                                        i8 = i6;
                                        f4 = f3;
                                        i9 = i4;
                                        ...
                                        i3 = 0;
                                        while (i3 < 7) {
                                            f5 = solverVariable.strengthVector[i3] / f;
                                            if ((f5 >= f4 && i3 == i8) || i3 > i8) {
                                                i9 = i7;
                                                i4 = i5;
                                                f4 = f5;
                                                i8 = i3;
                ...
                if (i3 == -1) {
                    ArrayRow arrayRow2 = linearSystem.mRows[i3];
                    arrayRow2.variable.definitionId = -1;
                    if (sMetrics != null) {
                        Metrics metrics2 = sMetrics;
                        metrics2.pivots++;
                    }
                    arrayRow2.pivot(linearSystem.mCache.mIndexedVariables[i4]);
                    arrayRow2.variable.definitionId = i3;
                    arrayRow2.variable.updateReferencesWithNewDefinition(arrayRow2);
                } else {
                    obj = 1;
        ...
        while (obj == null) {
            ...
            int i52 = 0;
            int i62 = 0;
            while (i52 < linearSystem.mNumRows) {
                ArrayRow arrayRow3 = linearSystem.mRows[i52];
                if (arrayRow3.variable.mType == Type.UNRESTRICTED) {
                    if (arrayRow3.isSimpleDefinition) {
                        if (arrayRow3.constantValue < f2) {
                            i7 = 1;
                            while (i7 < linearSystem.mNumColumns) {
                                solverVariable = linearSystem.mCache.mIndexedVariables[i7];
                                f = arrayRow3.variables.get(solverVariable);
                                if (f <= f2) {
                                    i8 = i62;
                                    f4 = f32;
                                    i9 = i42;
                                    ...
                                    i32 = 0;
                                    while (i32 < 7) {
                                        f5 = solverVariable.strengthVector[i32] / f;
                                        if (f5 >= f4) {
                                        }
                                        i32++;
                                    }
            ...
            if (i32 == -1) {
                ...
                ArrayRow arrayRow22 = linearSystem.mRows[i32];
                arrayRow22.variable.definitionId = -1;
                if (sMetrics != null) {
                    Metrics metrics22 = sMetrics;
                    metrics22.pivots++;
                }
                arrayRow22.pivot(linearSystem.mCache.mIndexedVariables[i42]);
                arrayRow22.variable.definitionId = i32;
                arrayRow22.variable.updateReferencesWithNewDefinition(arrayRow22);
            }
            f2 = 0.0f;
        }
        return i22;
    ...
    public void addGreaterThan(SolverVariable solverVariable, SolverVariable solverVariable2, int i, int i2) {
        ...
        if (i2 != 6) {
            addSingleError(createRow, (int) (-1082130432 * createRow.variables.get(createSlackVariable)), i2);
        }
    ...
    public void addGreaterBarrier(SolverVariable solverVariable, SolverVariable solverVariable2, boolean z) {
        ...
        if (z) {
            addSingleError(createRow, (int) (-1082130432 * createRow.variables.get(createSlackVariable)), 1);
        }
        addConstraint(createRow);
    }
