            ...
            if (!isConnected && !isConnected2 && !isConnected3) {
                ...
                if (obj2 != null) {
                    if (z2) {
                        ...
                        i11 = i9;
                        i9 = i3;
                        linearSystem2.addEquality(solverVariable4, createObjectVariable, i10, i11);
                    } else {
                        obj3 = obj2;
                        solverVariable4 = solverVariable6;
                    ...
                    if (i18 != 1) {
                        ...
                        if (constraintAnchor.getType() != Type.TOP) {
                            if (constraintAnchor.getType() == Type.BOTTOM) {
                                ...
                                solverVariable9 = createObjectVariable6;
                                solverVariable8 = createObjectVariable4;
                                i12 = i13;
                                linearSystem2.addConstraint(linearSystem.createRow().createRowDimensionRatio(solverVariable4, createObjectVariable, createObjectVariable5, solverVariable9, f2));
                                obj3 = null;
                                if (!(obj3 == null || i17 == 2 || z3)) {
                                    i10 = Math.max(i9, i10);
                                    if (i11 > 0) {
                        ...
                        createObjectVariable3 = linearSystem2.createObjectVariable(constraintWidget.mParent.getAnchor(Type.TOP));
                ...
                if (z5) {
                    if (z4) {
                        if (!isConnected || r24 || r23) {
                            ...
                            if (!isConnected && !r24) {
                                if (z) {
                                    linearSystem2.addGreaterThan(solverVariable10, solverVariable4, 0, 5);
                                }
                                i15 = i14;
                                i9 = 6;
                                if (z) {
                                ...
                                return;
                            } else if (isConnected && r24) {
                                linearSystem2.addEquality(solverVariable4, solverVariable8, -constraintAnchor2.getMargin(), 6);
                                if (z) {
                                ...
                                if (isConnected && r24) {
                                    if (obj3 == null) {
                                        ...
                                        if (i12 != 0) {
                                            if (i11 <= 0) {
                                                if (i9 > 0) {
                                                    i8 = 6;
                                                    obj5 = null;
                                                    createObjectVariable3 = solverVariable7;
                                                    linearSystem2.addEquality(createObjectVariable, createObjectVariable3, constraintAnchor.getMargin(), i8);
                                                    linearSystem2.addEquality(solverVariable4, solverVariable8, -constraintAnchor2.getMargin(), i8);
                                                    if (i11 <= 0) {
                                                        if (i9 <= 0) {
                                                            obj2 = null;
                                                            obj6 = obj5;
                                            ...
                                            if (i12 == 1) {
                                                ...
                                                i8 = z3 ? 6 : 4;
                                                linearSystem2.addEquality(createObjectVariable, solverVariable3, constraintAnchor.getMargin(), i8);
                                                linearSystem2.addEquality(solverVariable4, solverVariable8, -constraintAnchor2.getMargin(), i8);
                                                i16 = 5;
                                                obj6 = 1;
                                            } else {
                                        ...
                                        if (obj4 == null) {
                                            ...
                                            solverVariable10 = createObjectVariable;
                                            linearSystem2.addCentering(createObjectVariable, solverVariable3, constraintAnchor.getMargin(), f, solverVariable8, solverVariable4, constraintAnchor2.getMargin(), i16);
                                        } else {
                                            solverVariable10 = createObjectVariable;
                                        }
                                        if (obj6 == null) {
                                            i9 = 6;
                                            linearSystem2.addGreaterThan(solverVariable10, solverVariable3, constraintAnchor.getMargin(), 6);
                                            linearSystem2.addLowerThan(solverVariable4, solverVariable8, -constraintAnchor2.getMargin(), 6);
                                        } else {
                                            i9 = 6;
                                        }
                                        if (z) {
                                            i15 = 0;
                                            linearSystem2.addGreaterThan(solverVariable10, solverVariable, 0, i9);
                                            if (z) {
                                                linearSystem2.addGreaterThan(solverVariable2, solverVariable4, i15, i9);
                                            }
                                            return;
                                    ...
                                    solverVariable3 = solverVariable7;
                                    if (z) {
                                        linearSystem2.addGreaterThan(createObjectVariable, solverVariable3, constraintAnchor.getMargin(), 5);
                                        linearSystem2.addLowerThan(solverVariable4, solverVariable8, -constraintAnchor2.getMargin(), 5);
                                    }
                                    i16 = 5;
                                    obj6 = null;
                                    if (obj4 == null) {
                ...
                if (i17 < 2 && z) {
                    ...
                    linearSystem2.addGreaterThan(solverVariable8, solverVariable4, 0, 6);
                }
            }
        }
        z6 = isConnected2;
                ...
                if (i18 == 2) {
                    ...
                    if (constraintAnchor.getType() != Type.TOP) {
                        if (constraintAnchor.getType() == Type.BOTTOM) {
                            ...
                            createObjectVariable5 = linearSystem2.createObjectVariable(constraintWidget.mParent.getAnchor(Type.RIGHT));
                            solverVariable9 = createObjectVariable62;
                            solverVariable8 = createObjectVariable4;
                            i12 = i13;
                            linearSystem2.addConstraint(linearSystem.createRow().createRowDimensionRatio(solverVariable4, createObjectVariable, createObjectVariable5, solverVariable9, f2));
                            obj3 = null;
