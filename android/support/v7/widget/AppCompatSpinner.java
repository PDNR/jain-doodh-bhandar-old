                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == 1) {
                                    i2 = new DropdownPopup(this.mPopupContext, attributeSet, i);
                                    theme = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, R.styleable.Spinner, i, 0);
                                    this.mDropDownWidth = theme.getLayoutDimension(R.styleable.Spinner_android_dropDownWidth, -2);
                                    i2.setBackgroundDrawable(theme.getDrawable(R.styleable.Spinner_android_popupBackground));
                                    i2.setPromptText(obtainStyledAttributes.getString(R.styleable.Spinner_android_prompt));
                                    theme.recycle();
                                    this.mPopup = i2;
                                ...
                                i2 = obtainStyledAttributes.getTextArray(R.styleable.Spinner_android_entries);
                                if (i2 != 0) {
                                    arrayAdapter = new ArrayAdapter(context, 17367048, i2);
