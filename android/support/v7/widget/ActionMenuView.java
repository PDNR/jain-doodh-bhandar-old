    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (paddingLeft < i3) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                size = measureChildForCells(childAt, i9, layoutParams2.isOverflowButton ? 1 : i10, childMeasureSpec, paddingTop);
                ...
                if (z2) {
                    while (size2 < size) {
                        ...
                        if (layoutParams.expanded) {
                            ...
                            i3 = i6;
                            childAt3.measure(MeasureSpec.makeMeasureSpec((layoutParams.cellsUsed * i9) + layoutParams.extraPixels, 1073741824), i3);
                        }
                        size2++;
                        i6 = i3;
                    }
