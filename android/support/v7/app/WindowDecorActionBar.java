...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z)) {
            ...
            if (z) {
                z = new int[]{0, 0};
                this.mContainerView.getLocationInWindow(z);
                f -= (float) z[1];
            }
            this.mContainerView.setTranslationY(f);
            z = new ViewPropertyAnimatorCompatSet();
            ...
            if (this.mContentAnimations && this.mContentView != null) {
                ...
                z.play(ViewCompat.animate(this.mContentView).translationY(0.0f));
            }
            z.setInterpolator(sShowInterpolator);
            z.setDuration(250);
            z.setListener(this.mShowListener);
            this.mCurrentShowAnim = z;
            z.start();
        } else {
            this.mContainerView.setAlpha(1.0f);
            this.mContainerView.setTranslationY(0.0f);
            if (this.mContentAnimations && this.mContentView) {
                this.mContentView.setTranslationY(0.0f);
            }
            this.mShowListener.onAnimationEnd(null);
        }
        if (this.mOverlayLayout) {
            ViewCompat.requestApplyInsets(this.mOverlayLayout);
        }
    }
    ...
    public void doHide(boolean z) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || z)) {
            ...
            z = ViewCompat.animate(this.mContainerView).translationY(f);
            z.setUpdateListener(this.mUpdateListener);
            viewPropertyAnimatorCompatSet.play(z);
            if (this.mContentAnimations && this.mContentView) {
