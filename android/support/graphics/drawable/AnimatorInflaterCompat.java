...
public class AnimatorInflaterCompat {
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        if (namedString != null) {
            ...
            if (namedString2 == null && xmlPullParser == null) {
                i = new StringBuilder();
            ...
            setupPathMotion(PathParser.createPathFromPathData(namedString), objectAnimator, 1056964608 * f, namedString2, xmlPullParser);
            return;
        }
